...
<head>
    ...
    <title>Login Aplikasi Kasir | byKelompok 5</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/dafa-modified.png" alt="" width="72" height="72">
      ...
      <p class="mt-3 mb-3 text-white">&copy; 2022 Developed by - <a target="_blank" rel="noopener noreferrer" href="" class="text-white">
     Kelompok 5 </a></p>
    </form>
